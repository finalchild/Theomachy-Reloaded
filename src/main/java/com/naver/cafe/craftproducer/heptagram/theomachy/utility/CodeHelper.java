...
public class CodeHelper {
    ...
    private static void showCode() {
        ...
        Theomachy.log.info(String.format("%" + w[0] + "s : %" + w[1] + "s %" + w[2] + "s : %" + w[3] + "s", "Ares", "8", "Assassin", "108"));
        ...
        Theomachy.log.info(String.format("%" + w[0] + "s : %" + w[1] + "s %" + w[2] + "s : %" + w[3] + "s", "Dionysus", "12", "Cloaking", "112"));
