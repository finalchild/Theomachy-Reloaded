...
public class CommandTheomachy implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (args.length == 0) // 설명 보기
        {
            ...
            sender.sendMessage(ChatColor.YELLOW + ("/t aaaaa     ") + ChatColor.WHITE + ("능력을 설정합니다."));
            ...
            sender.sendMessage(ChatColor.YELLOW + ("/t info(i)  ") + ChatColor.AQUA + ("<TeamName>     ") + ChatColor.WHITE + ("해당 팀의 구성원들을 확인합니다."));
        	...
        	case "stop":
        		...
        		break;
        	case "ability": case "a":
        		CommandAbility.onCommand(sender, cmd, label, args);
        		break;
        	case "aaaaa":
        		CommandAbilities.onCommand(sender);
        		break;
        	case "help":
        		CommandHelp.onCommand(sender, cmd, label, args);
        		break;
        	case "spawn": case "s":
        		CommandSpawn.onCommand(sender, cmd, label, args);
        		break;
        	case "team": case "t":
        		CommandTeam.onCommand(sender, cmd, label, args);
        		break;
        	case "info": case "i":
        		CommandTeamInfo.onCommand(sender, cmd, label, args);
        		break;
        	case "clear": case "c":
