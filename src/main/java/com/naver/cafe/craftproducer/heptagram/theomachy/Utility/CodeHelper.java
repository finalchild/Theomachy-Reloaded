...
public class CodeHelper
{
	...
	private static void showCode()
	{
		...
		Theomachy.log.info(String.format("%"+w[0]+"s %23s","======god=====", "======human====="));
		Theomachy.log.info(String.format("%"+w[0]+"s : %"+w[1]+"s %"+w[2]+"s : %"+w[3]+"s", "Zeus",		"1",	 "Archer",			"101"));
		Theomachy.log.info(String.format("%"+w[0]+"s : %"+w[1]+"s %"+w[2]+"s : %"+w[3]+"s", "Poseidon",	"2", 	 "Miner",			"102"));
		Theomachy.log.info(String.format("%"+w[0]+"s : %"+w[1]+"s %"+w[2]+"s : %"+w[3]+"s", "Hades",	"3",	 "Stance",			"103"));
		Theomachy.log.info(String.format("%"+w[0]+"s : %"+w[1]+"s %"+w[2]+"s : %"+w[3]+"s", "Demeter",	"4",	 "Teleporter",		"104"));
		Theomachy.log.info(String.format("%"+w[0]+"s : %"+w[1]+"s %"+w[2]+"s : %"+w[3]+"s", "Athena",	"5",	 "Bomber",			"105"));
		Theomachy.log.info(String.format("%"+w[0]+"s : %"+w[1]+"s %"+w[2]+"s : %"+w[3]+"s", "Apollon",	"6",	 "Creeper",			"106"));
		Theomachy.log.info(String.format("%"+w[0]+"s : %"+w[1]+"s %"+w[2]+"s : %"+w[3]+"s", "Artemis",	"7",	 "Wizard",			"107"));
		Theomachy.log.info(String.format("%"+w[0]+"s : %"+w[1]+"s %"+w[2]+"s : %"+w[3]+"s", "Ares",		"8",	 "Assasin",			"108"));
		Theomachy.log.info(String.format("%"+w[0]+"s : %"+w[1]+"s %"+w[2]+"s : %"+w[3]+"s", "Hepaestus","9",	 "Reflection",		"109"));
		Theomachy.log.info(String.format("%"+w[0]+"s : %"+w[1]+"s %"+w[2]+"s : %"+w[3]+"s", "Asclipius","10",	 "Blinder",			"110"));
		Theomachy.log.info(String.format("%"+w[0]+"s : %"+w[1]+"s %"+w[2]+"s : %"+w[3]+"s", "Hermes",	"11",	 "Invincibility",	"111"));
		Theomachy.log.info(String.format("%"+w[0]+"s : %"+w[1]+"s %"+w[2]+"s : %"+w[3]+"s", "Dionysus",	"12",	 "Clocking",		"112"));
		Theomachy.log.info(String.format(						 "%"+w[4]+"s : %"+w[3]+"s",						 "Blacksmith",		"113"));
		Theomachy.log.info(String.format(						 "%"+w[4]+"s : %"+w[3]+"s",						 "Boxer",			"114"));
		Theomachy.log.info(String.format(						 "%"+w[4]+"s : %"+w[3]+"s",						 "Priest",			"115"));
		Theomachy.log.info(String.format(						 "%"+w[4]+"s : %"+w[3]+"s",						 "Witch",			"116"));
		Theomachy.log.info(String.format(						 "%"+w[4]+"s : %"+w[3]+"s",						 "Meteor",			"117"));
		Theomachy.log.info(String.format(						 "%"+w[4]+"s : %"+w[3]+"s",						 "Sniper",			"118"));
	...
	private static void showCode(CommandSender sender)
	{
		sender.sendMessage(ChatColor.YELLOW+"신-------\n" +
				...
				ChatColor.RED + "아스클리피어스 "+ChatColor.WHITE+":"+ChatColor.GOLD+" 10\n" +
