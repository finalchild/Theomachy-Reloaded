...
public class Dionysus extends Ability {	
    ...
    public void description() {
        ...
        player.sendMessage(
                ...
                + " ===================");
        player.sendMessage(
                ChatColor.YELLOW + "[ 디오니소스 ]  " + ChatColor.RED
                + "[ 신 ]  " + ChatColor.BLUE + "Passive,DeBuff  "
        ...
        if (player.getName().equals(playerName)) {
            ...
            if (rn == 0) {
                ...
                target.addPotionEffect(
                        new PotionEffect(PotionEffectType.SLOW, 200, 0), true);
                target.addPotionEffect(
                        new PotionEffect(PotionEffectType.WEAKNESS, 200, 0),
                        true);
                target.addPotionEffect(
                        new PotionEffect(PotionEffectType.CONFUSION, 240, 0),
                        true);
