...
public class Witch extends Ability {
    ...
    public void description() {
        ...
        player.sendMessage(
                ...
                + " ===================");
        player.sendMessage(
                ChatColor.YELLOW + "[ 마녀 ]  " + ChatColor.RED
            ...
            if (targetList != null) {
                ...
                for (Player e : targetList) {
                    ...
                    e.addPotionEffect(
                            ...
                            true);
                    e.addPotionEffect(
                            new PotionEffect(PotionEffectType.SLOW_DIGGING, 200,
                            0),
                            true);
        ...
        if (player.getName().equals(playerName)) {
            ...
            if (rn == 0) {
                ...
                target.addPotionEffect(
                        new PotionEffect(PotionEffectType.HUNGER, 100, 0), true); // *20	
                target.addPotionEffect(
                        new PotionEffect(PotionEffectType.POISON, 100, 0), true);
                target.addPotionEffect(
                        new PotionEffect(PotionEffectType.SLOW, 100, 0), true);
                target.addPotionEffect(
                        new PotionEffect(PotionEffectType.HUNGER, 100, 0), true);
                target.addPotionEffect(
                        new PotionEffect(PotionEffectType.SLOW_DIGGING, 100, 0),
                        true);
